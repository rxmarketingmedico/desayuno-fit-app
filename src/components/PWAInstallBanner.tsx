...
export function PWAInstallBanner() {
  ...
  return (
    <div
      ...
      className="md:hidden fixed bottom-20 inset-x-4 z-40 animate-in slide-in-from-bottom-4 fade-in duration-300"
    >
        ...
        <div className="flex items-start gap-3 pr-6">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="text-sm font-semibold text-foreground">
              Instala Desayuno Fit
            </h3>
            {platform === "ios" ? (
              <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                Toca <Share className="inline h-3.5 w-3.5 align-text-bottom" /> Compartir y luego{" "}
